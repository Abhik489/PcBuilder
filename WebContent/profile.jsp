		...
		<section class="menu-wrapper">
			<ul>
				...
				if (session != null) {
					...
					String email= (String)session.getAttribute("pass");
	...
	<div class="container">
		...
		<div class="mainprofile">
			...
			<div class="edit">
				...
				<br> <span><b>Username </b>${uname}</span>
				<br> <span><b>Email: </b>${pass}</span><br>
			</div>
				    ...
				    <section class="eform">
				        ...
				        <table>
				            <tr>
				                ...
				                <td><input type="text" name="username" value="" placeholder="${uname}"></td>
				            </tr>
				    ...
				    <section class="eform">
				        ...
				        <table>
				            ...
				            <tr>
				                ...
				                <td><input type="text" value="" name="newpassword" placeholder=""></td>
				            </tr>
