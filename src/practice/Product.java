...
public class Product {
	 ...
	 private String product_ram_gpu_size;
	 private String product_ram_gpu_type;
	 private int product_hdd_rpm;
	 private String product_hdd_gpu_interface;
	...
	public String getProduct_ram_gpu_size() {
		return product_ram_gpu_size;
	}
	public void setProduct_ram_gpu_size(String product_ram_gpu_size) {
		this.product_ram_gpu_size = product_ram_gpu_size;
	}
	...
	public String getProduct_hdd_gpu_interface() {
		return product_hdd_gpu_interface;
	}
	public void setProduct_hdd_gpu_interface(String product_hdd_gpu_interface) {
		this.product_hdd_gpu_interface = product_hdd_gpu_interface;
	}
